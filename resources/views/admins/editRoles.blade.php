                    ...
                    <div class="mt-10 sm:mt-0">
                        <div class="md:grid md:grid-cols-3 md:gap-6">
                            ...
                            <div class="mt-5 md:mt-0 md:col-span-2">
                                ...
                                <form action="/admin/roles/{{ $role->id }}/update" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PATCH')
                                        ...
                                        <div class="px-4 py-5 bg-white sm:p-6">
                                            <div class="grid grid-cols-6 gap-6">
                                                <div class="col-span-6 sm:col-span-3">
                                                    ...
                                                    <input type="text" value="{{ $role->name }}" name="name" id="name" autocomplete="given-name" required class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
                                                </div>   
                                            </div>
                                        </div>
