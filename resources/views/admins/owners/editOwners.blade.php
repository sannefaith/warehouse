                    ...
                    <div class="mt-10 sm:mt-0">
                        <div class="md:grid md:grid-cols-3 md:gap-6">
                            ...
                            <div class="mt-5 md:mt-0 md:col-span-2">
                                ...
                                <form action="/admin/owners/{{ $user->id }}/update" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PATCH')
                                    ...
                                    <div class="shadow overflow-hidden sm:rounded-md">
                                        ...
                                        <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                                            ...
                                            <a href="{{ route('admins.owners.showOwners') }}" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">Cancel</a>
                                        </div>
                                    </div>
                                </form>
