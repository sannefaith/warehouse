                                        ...
                                        <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                                            ...
                                            <div>
                                                ...
                                                <div class="mt-1">
                                                    ...
                                                    id="description" name="description" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md" placeholder=""></textarea>
                                                </div>
                                            ...
                                            <div>
                                                ...
                                                <div class="mt-1">
                                                    <textarea value="{{ old('office') ?? $user->profile->office }}" id="office" name="office" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md" placeholder=""></textarea>
                                                </div>
                                                <p class="mt-2 text-sm text-gray-500">
